...
const Collection = () => {
  ...
  return <>
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        <div className={`border border-gray-300 py-3 pl-5 my-5 ${showFilter ? "" : "hidden"} sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 " value={'Innerwears'} onChange={toggleSubCategory} /> Innerwears
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 " value={'Winterwear'} onChange={toggleSubCategory} /> Winterwear
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 " value={'Kurtis'} onChange={toggleSubCategory} /> Kurtis
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3 " value={'Sarees & Suits'} onChange={toggleSubCategory} /> Sarees & Suits
            </p>
            <p className="flex gap-2">
      ...
      <div className={`border border-gray-300 py-3 pl-5 my-5 ${showFilter ? "" : "hidden"} sm:block`}>
          <p className="mt-3 text-sm font-medium">Fashion</p>
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'Beauty & Makeup'} onChange={toggleSubCategory} /> Beauty & Makeup
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'Footwears'} onChange={toggleSubCategory} /> Footwears
            </p>
            <p className="flex gap-2">
